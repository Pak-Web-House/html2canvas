...
* add rtl render support ([#2653](https://github.com/Pak-Web-House/html2canvas/issues/2653)) ([6947982](https://github.com/Pak-Web-House/html2canvas/commit/694798284838b16882e648914da0905818aa366c))
* add support for <video> elements ([#2788](https://github.com/Pak-Web-House/html2canvas/issues/2788)) ([181d1b1](https://github.com/Pak-Web-House/html2canvas/commit/181d1b1103910d6e1b5277d5c007fc5e3006c6bf))
* add support for data-html2canvas-debug property for debugging ([#2658](https://github.com/Pak-Web-House/html2canvas/issues/2658)) ([cd0d725](https://github.com/Pak-Web-House/html2canvas/commit/cd0d7258c3a93f2989d5d9ec0244ba2763ea2d23))
* add support for webkit-text-stroke and paint-order ([#2591](https://github.com/Pak-Web-House/html2canvas/issues/2591)) ([522e5aa](https://github.com/Pak-Web-House/html2canvas/commit/522e5aac5fdad090953d095b5d558053a5e2d43d))
* allow access to reference element in onclone ([#2584](https://github.com/Pak-Web-House/html2canvas/issues/2584)) ([58b4591](https://github.com/Pak-Web-House/html2canvas/commit/58b45911741c0dbbccd462b2976560bb3999eaef))
* correctly break graphemes ([#2652](https://github.com/Pak-Web-House/html2canvas/issues/2652)) ([437b367](https://github.com/Pak-Web-House/html2canvas/commit/437b367d3ba9dfd7f9a4c8042ac8d00208c09770))
* ignore unsupported image functions ([#1873](https://github.com/Pak-Web-House/html2canvas/issues/1873)) ([61f4819](https://github.com/Pak-Web-House/html2canvas/commit/61f4819e02102b112513d57b16ec7d37e989af20))
* support for custom and slot elements ([#2581](https://github.com/Pak-Web-House/html2canvas/issues/2581)) ([acb4cd2](https://github.com/Pak-Web-House/html2canvas/commit/acb4cd24b85527908c02a60794768949578678f0))
* use native text segmenter where available ([#2782](https://github.com/Pak-Web-House/html2canvas/issues/2782)) ([6521a48](https://github.com/Pak-Web-House/html2canvas/commit/6521a487d78172f7179f7c973c1a3af40eb92009))


### Bug Fixes

* "offsets" text when font is big ([fd22a01](https://github.com/Pak-Web-House/html2canvas/commit/fd22a01a3c9e39293f47caaed0c0e13d2dc8170c))
* [#1868](https://github.com/Pak-Web-House/html2canvas/issues/1868) Clone node, Setting className for SVG element raises error ([#2079](https://github.com/Pak-Web-House/html2canvas/issues/2079)) ([f139b51](https://github.com/Pak-Web-House/html2canvas/commit/f139b513c5cf9673dc727fd47124e0d779891e3a))
* adopted stylesheets ([#2785](https://github.com/Pak-Web-House/html2canvas/issues/2785)) ([74696fa](https://github.com/Pak-Web-House/html2canvas/commit/74696faf47c07b48b9c9587db0b999da1c08a8be))
* allow proxy url with parameters ([#2100](https://github.com/Pak-Web-House/html2canvas/issues/2100)) ([a4a3ce8](https://github.com/Pak-Web-House/html2canvas/commit/a4a3ce8a2eb6a4f43f1bc9a7935eb16f2b98a3cd))
* concatenate contiguous font-family tokens ([#2219](https://github.com/Pak-Web-House/html2canvas/issues/2219)) ([bacfadf](https://github.com/Pak-Web-House/html2canvas/commit/bacfadff96d907d9e8ab4ef515ca6487de9e51fc))
* const enums ([#2651](https://github.com/Pak-Web-House/html2canvas/issues/2651)) ([eeda86b](https://github.com/Pak-Web-House/html2canvas/commit/eeda86bd5e81fb4e97675fe9bee3d4d15899997f))
* context scale for high resolution displays with foreignobjectrendering  ([#1782](https://github.com/Pak-Web-House/html2canvas/issues/1782)) ([7027900](https://github.com/Pak-Web-House/html2canvas/commit/7027900f4993dcd00745a4db045ed1c0e3255f8a))
* correctly handle allowTaint canvas cloning ([#2649](https://github.com/Pak-Web-House/html2canvas/issues/2649)) ([c378e22](https://github.com/Pak-Web-House/html2canvas/commit/c378e220694c14cb7b3b4b8650a7757f8fc23c7a))
* correctly render partial borders (fix [#1920](https://github.com/Pak-Web-House/html2canvas/issues/1920)) ([#2010](https://github.com/Pak-Web-House/html2canvas/issues/2010)) ([eedb81e](https://github.com/Pak-Web-House/html2canvas/commit/eedb81ef9e114366a7e286e975659360cf9d0983))
* correctly respect logging option ([#2013](https://github.com/Pak-Web-House/html2canvas/issues/2013)) ([34b06d6](https://github.com/Pak-Web-House/html2canvas/commit/34b06d6365603c3b16664ab7804efe94c7945946))
* crash on background-size with calc() (fix [#2469](https://github.com/Pak-Web-House/html2canvas/issues/2469)) ([#2569](https://github.com/Pak-Web-House/html2canvas/issues/2569)) ([084017a](https://github.com/Pak-Web-House/html2canvas/commit/084017a67319a993d73c6bdf612dd8532f1b8dbe))
* disable transition properties ([#2659](https://github.com/Pak-Web-House/html2canvas/issues/2659)) ([f143166](https://github.com/Pak-Web-House/html2canvas/commit/f1431665513e0a4636fb167a241f4a0571ba728a))
* don't apply text shadows on elements ([#1795](https://github.com/Pak-Web-House/html2canvas/issues/1795)) ([397595a](https://github.com/Pak-Web-House/html2canvas/commit/397595afb59ee50f0d128abb5945b5b9ddc6650d))
* don't copy 'all' css property ([#2586](https://github.com/Pak-Web-House/html2canvas/issues/2586)) ([fa60716](https://github.com/Pak-Web-House/html2canvas/commit/fa60716d07ed590ec64543a586a7960cbc8557df))
* element cropping & scrolling ([#2625](https://github.com/Pak-Web-House/html2canvas/issues/2625)) ([878e37a](https://github.com/Pak-Web-House/html2canvas/commit/878e37a24272d0412fe589975ef8eed931c56e0b))
* emoji line breaking (fix [#1813](https://github.com/Pak-Web-House/html2canvas/issues/1813)) ([#2621](https://github.com/Pak-Web-House/html2canvas/issues/2621)) ([7d788c6](https://github.com/Pak-Web-House/html2canvas/commit/7d788c6f3d221b87f6b59fcda8517731340b2d1f))
* enforce colorstop min 0 ([#1743](https://github.com/Pak-Web-House/html2canvas/issues/1743)) ([349bbf1](https://github.com/Pak-Web-House/html2canvas/commit/349bbf137abd83464e074db3948fc79a541c2ef3))
* Ensure resizeImage's canvas has at least 1px of width and height ([#2409](https://github.com/Pak-Web-House/html2canvas/issues/2409)) ([bb92371](https://github.com/Pak-Web-House/html2canvas/commit/bb9237155cf0ec090432ee6c5d9c555eb6ffa81f))
* external styles on svg elements ([#2320](https://github.com/Pak-Web-House/html2canvas/issues/2320)) ([1514220](https://github.com/Pak-Web-House/html2canvas/commit/1514220812cfb22d64d0974558d9c14fe90a41d3))
* finish animation/transitions for elements ([#2632](https://github.com/Pak-Web-House/html2canvas/issues/2632)) ([969638f](https://github.com/Pak-Web-House/html2canvas/commit/969638fb94a0a14c64a667fa6e5689f79d9f1044))
* handle unhandled promise rejections ([#2568](https://github.com/Pak-Web-House/html2canvas/issues/2568)) ([4555940](https://github.com/Pak-Web-House/html2canvas/commit/4555940d0bc17b7fd9327dd0164c382a3dbf1858))
* iframe load to ensure images are loaded ([#2577](https://github.com/Pak-Web-House/html2canvas/issues/2577)) ([eeb5a3e](https://github.com/Pak-Web-House/html2canvas/commit/eeb5a3ea1d6c94e0f6dcfd40695eb88ebb3e0041))
* image blob rendering ([1acdc82](https://github.com/Pak-Web-House/html2canvas/commit/1acdc827a4e05933c2f7c9558405c66b7cd82f58))
* image loading="lazy" fix [#2312](https://github.com/Pak-Web-House/html2canvas/issues/2312) ([#2314](https://github.com/Pak-Web-House/html2canvas/issues/2314)) ([f23e6f6](https://github.com/Pak-Web-House/html2canvas/commit/f23e6f6f2690dc0dbd02621c3bb81025904e6647))
* ios 15 font rendering crash ([#2645](https://github.com/Pak-Web-House/html2canvas/issues/2645)) ([ba2b1cd](https://github.com/Pak-Web-House/html2canvas/commit/ba2b1cd8e9a9d7932675d7abffce1526a609e769))
* ios text wrapping with 0 width rect ([#2786](https://github.com/Pak-Web-House/html2canvas/issues/2786)) ([0476d06](https://github.com/Pak-Web-House/html2canvas/commit/0476d065158c33d2020a9f602b3043e5e2f90c75))
* logger unique names ([#2575](https://github.com/Pak-Web-House/html2canvas/issues/2575)) ([1715854](https://github.com/Pak-Web-House/html2canvas/commit/171585491dd1bee4f30691328bd22e978f3ac79e))
* multi arg transition/animation duration ([#2657](https://github.com/Pak-Web-House/html2canvas/issues/2657)) ([1b55ed5](https://github.com/Pak-Web-House/html2canvas/commit/1b55ed5668dcbbe1c6d8d7e94736d8f2da2d31c5))
* multi token overflow [#1850](https://github.com/Pak-Web-House/html2canvas/issues/1850) ([#1851](https://github.com/Pak-Web-House/html2canvas/issues/1851)) ([409674f](https://github.com/Pak-Web-House/html2canvas/commit/409674fba6f8038eb174b9c89360ef8b342971e9))
* natural sizes for images with srcset ([#2622](https://github.com/Pak-Web-House/html2canvas/issues/2622)) ([96e23d1](https://github.com/Pak-Web-House/html2canvas/commit/96e23d185198b7131cf0cfa31c14c165790464e9))
* nested z-index ordering ([#2011](https://github.com/Pak-Web-House/html2canvas/issues/2011)) ([00555cf](https://github.com/Pak-Web-House/html2canvas/commit/00555cf1efddfed5877811d8a03a326f9943ab06)), closes [#1978](https://github.com/Pak-Web-House/html2canvas/issues/1978)
* none image ([#2627](https://github.com/Pak-Web-House/html2canvas/issues/2627)) ([6651fc6](https://github.com/Pak-Web-House/html2canvas/commit/6651fc6789d5902d171dc53b4094887870433018))
* null backgroundColor option as transparent ([#2012](https://github.com/Pak-Web-House/html2canvas/issues/2012)) ([7d3456b](https://github.com/Pak-Web-House/html2canvas/commit/7d3456b78c37e7333db087601805b32ec7ca0253))
* opacity with overflow hidden ([#2450](https://github.com/Pak-Web-House/html2canvas/issues/2450)) ([82b7da5](https://github.com/Pak-Web-House/html2canvas/commit/82b7da558c342e7f53d298bb1d843a5db86c3b21))
* overflow-wrap break-word ([#2626](https://github.com/Pak-Web-House/html2canvas/issues/2626)) ([95a46b0](https://github.com/Pak-Web-House/html2canvas/commit/95a46b00c53563722c035a0e45fdf5fb507275e4))
* overflows with absolutely positioned content ([#2663](https://github.com/Pak-Web-House/html2canvas/issues/2663)) ([38c6829](https://github.com/Pak-Web-House/html2canvas/commit/38c682955a9299ca7785af71d8f251df799405b0))
* parsing counter content in pseudo element ([#2640](https://github.com/Pak-Web-House/html2canvas/issues/2640)) ([1941b9e](https://github.com/Pak-Web-House/html2canvas/commit/1941b9e0acfd9243da0beaf70e1643cab1b4a963))
* prevent unhandled promise rejections for hidden frames ([#1762](https://github.com/Pak-Web-House/html2canvas/issues/1762)) ([5cbe5db](https://github.com/Pak-Web-House/html2canvas/commit/5cbe5db35155e3a9790a30de09feb17843053b7a))
* Properties x and y of BoundingRect is undefined in old browser ([#2797](https://github.com/Pak-Web-House/html2canvas/issues/2797)) ([e587a82](https://github.com/Pak-Web-House/html2canvas/commit/e587a82dca01d9ada78cae34fd1bdb934e547f9b))
* radial gradient ry check ([#2631](https://github.com/Pak-Web-House/html2canvas/issues/2631)) ([a0dd38a](https://github.com/Pak-Web-House/html2canvas/commit/a0dd38a8be4e540ae1c1f4b4e41f6c386f3e454f))
* reduce SLICE_STACK_SIZE to 50k ([#2784](https://github.com/Pak-Web-House/html2canvas/issues/2784)) ([1cc853a](https://github.com/Pak-Web-House/html2canvas/commit/1cc853a3186853eaca00af060f651697dc3497a9))
* Render background-size correctly with no-repeat [#447](https://github.com/Pak-Web-House/html2canvas/issues/447) ([3f3424e](https://github.com/Pak-Web-House/html2canvas/commit/3f3424e49c4091af740764cbc54328e2e1753bd4))
* responsive svg images ([#2583](https://github.com/Pak-Web-House/html2canvas/issues/2583)) ([92fa448](https://github.com/Pak-Web-House/html2canvas/commit/92fa448913192d5e4e82bfe14f6644b669d4e6ef))
* safari data url taints ([#1797](https://github.com/Pak-Web-House/html2canvas/issues/1797)) ([4e4a231](https://github.com/Pak-Web-House/html2canvas/commit/4e4a231683904dfdc1f82472ece5a160a158dbb8))
* safari pseudo element content parsing ([#2018](https://github.com/Pak-Web-House/html2canvas/issues/2018)) ([3f59910](https://github.com/Pak-Web-House/html2canvas/commit/3f599103fb139f218ffe917800e74af2c7cc7ad5))
* source maps ([#2787](https://github.com/Pak-Web-House/html2canvas/issues/2787)) ([46db867](https://github.com/Pak-Web-House/html2canvas/commit/46db86755f064828559a4b0b37310f3ae94f5494))
* stack exceeding for css tokenizer ([#1862](https://github.com/Pak-Web-House/html2canvas/issues/1862)) ([cbaecdc](https://github.com/Pak-Web-House/html2canvas/commit/cbaecdca28cfaf9bd854e1b0c005cc8058208b36))
* svg d path getting truncated on copy ([#2589](https://github.com/Pak-Web-House/html2canvas/issues/2589)) ([dd6d885](https://github.com/Pak-Web-House/html2canvas/commit/dd6d8856eca820a13a0990c467b9e531433fd4a9))
* test for ios range line break error ([#2635](https://github.com/Pak-Web-House/html2canvas/issues/2635)) ([f43f942](https://github.com/Pak-Web-House/html2canvas/commit/f43f942fcd793dde9cdc6c0438f379ec3c05c405))
* text position for form elements and list markers ([#2588](https://github.com/Pak-Web-House/html2canvas/issues/2588)) ([cd99f11](https://github.com/Pak-Web-House/html2canvas/commit/cd99f11b1b9eb1260a548a63e2a370a0a5ddafa0))
* text-decoration-line fallback ([#2088](https://github.com/Pak-Web-House/html2canvas/issues/2088)) ([#2567](https://github.com/Pak-Web-House/html2canvas/issues/2567)) ([44296e5](https://github.com/Pak-Web-House/html2canvas/commit/44296e529368140ec06a937383e05f3074b19ee2))
* text-shadow position with baseline ([#2576](https://github.com/Pak-Web-House/html2canvas/issues/2576)) ([439e365](https://github.com/Pak-Web-House/html2canvas/commit/439e365ea8c703b528778a268dcfc3bf9ccad6a9))
* this.canvas.ownerDocument is undefined ([#2590](https://github.com/Pak-Web-House/html2canvas/issues/2590)) ([45efe54](https://github.com/Pak-Web-House/html2canvas/commit/45efe54da8145f97b9ee0463e686103280e3c8b1))
* type import that is only available ts 3.8 or higher ([#2629](https://github.com/Pak-Web-House/html2canvas/issues/2629)) ([c5c6fa0](https://github.com/Pak-Web-House/html2canvas/commit/c5c6fa00d71f36ef963ba5170ebc7b668d39c407))
* typescript options type definition ([#1861](https://github.com/Pak-Web-House/html2canvas/issues/1861)) ([cae44a6](https://github.com/Pak-Web-House/html2canvas/commit/cae44a6f0a6649bd8a7c4250a20792bb5c2e5b42))
* use baseline for text positioning ([#2109](https://github.com/Pak-Web-House/html2canvas/issues/2109)) ([85f79c1](https://github.com/Pak-Web-House/html2canvas/commit/85f79c1a5e4c0b422ace552c430dd389c8477a44))
* using existing canvas option ([#2017](https://github.com/Pak-Web-House/html2canvas/issues/2017)) ([0764920](https://github.com/Pak-Web-House/html2canvas/commit/076492042a73d67b30e4562f2964200e07d25f5e))
* word-break seperators ([#2593](https://github.com/Pak-Web-House/html2canvas/issues/2593)) ([e9f7f48](https://github.com/Pak-Web-House/html2canvas/commit/e9f7f48d571304be14610a181feedca3c3b42864))
* wrap .sheet.cssRules access in try...catch. ([#1693](https://github.com/Pak-Web-House/html2canvas/issues/1693)) ([2c018d1](https://github.com/Pak-Web-House/html2canvas/commit/2c018d19875ced30caafdc40f84ca531de6e6f91))
* zero size iframe rendering ([#1863](https://github.com/Pak-Web-House/html2canvas/issues/1863)) ([81dcf7b](https://github.com/Pak-Web-House/html2canvas/commit/81dcf7b6be66920260a60908aa4b86e7530f6e17))
